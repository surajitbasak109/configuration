...
"   \_/ |_|_| |_| |_|_|  \___|
"
" Surajit's .vimrc file
" This is my awesome custom vimrc yipyy!
"
...
source ~/.vim/vimrcs/matchit.vim
source ~/.vim/vimrcs/comments.vim
...
autocmd BufRead *.php set syntax=php filetype=php
...
map <leader>ft :set filetype=php<cr>
